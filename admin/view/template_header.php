...
<body>
    <div class="row">
        <div class="col-md-2 bg-dark text-white p-4 ">
            <h3 class="text-center"><span class="text-danger">THE</span><span>DREAM</span></h3>
            <hr>
        ...
        <div class="col-md-10 p-0">
            <div class="shadow bg-danger text-white d-flex justify-content-between align-content-center  p-3 pb-1">
                <p>ADMIN THEDREAM</p>
                <div><span>Admin</span><img class="rounded m-1 border border-1 border-white" width="30px" height="30px" src="https://www.shutterstock.com/shutterstock/photos/1730974153/display_1500/stock-vector-man-with-the-inscription-admin-icon-outline-man-with-the-inscription-admin-vector-icon-for-web-1730974153.jpg" alt=""></div>
            </div>
