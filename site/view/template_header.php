...
<body>
            ...
            <div class="container text-white">
                <div class="row">
                    <div class="col-md-6 pt-3">
                        <p class="text-white fs-6"><img src="https://file.hstatic.net/1000402464/file/output-onlinegiftools_9bbbf15c266044699bca3a5635e05246.gif" width="30px" alt="">KHUYẾN MÃI LỚN VÀO NGÀY KHAI TRƯƠNG 20/10/2023</p>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg bg-white ">
                <div class="container px-0 mx-0">
                  ...
                  <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
                    <a class="navbar-brand" href="?mod=page&act=home"><span class="text-danger"><img src="../content/img/logo.jpg" alt=""></a>
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="?mod=page&act=home">TRANG CHỦ</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link text-black" href="?mod=page&act=category&id=1">ĐỒNG HỒ NAM</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link text-black" href="?mod=page&act=category&id=2">ĐỒNG HỒ NỮ</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link text-black" href="?mod=page&act=category&id=3">PHỤ KIỆN</a>
                      </li>
                    </ul>
    ...
    <div class="row">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../content/img/banner01.jpg" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="../content/img/banner00.jpg" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="../content/img/banner01.jpg" class="d-block w-100" alt="...">
                  </div>
        ...
        <div class="col-md-3 m-0">
            <img class="img-fluid" src="../content/img/bannerp1.jpg" alt="">
            <br><br>
            <img class="img-fluid" src="../content/img/bannerp2.jpg" alt="">
        </div>
    </div>